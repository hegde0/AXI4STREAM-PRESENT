...
module PRESENT_ENCRYPT (//output reg [4:0]round_dbg,
output reg[63:0] ciphered,
output reg done,
...
begin
   if (round==0)
   begin
      $display("TESTVECTOR=> ", $time, " plaintext=%x  key=%x  ciphertext=%x",idat,key,ciphered);        
end
end
`endif
